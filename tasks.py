...
def analyze_resume_simple(
    ...
    """Simple resume analysis using our free AI model"""
    try:
        simple_ai = SimpleAI()
        is_selected, feedback = simple_ai.analyze_resume(
...
def send_selection_email_simple(to_email: str, role: str, company_name: str = "Our Company") -> bool:
    """Simple email sending without agents"""
    try:
...
Congratulations! We are pleased to inform you that you have been selected for the {role} position at {company_name}.

Your application stood out due to your strong technical background and relevant experience. We are excited about the possibility of having you join our team.

Next Steps:
1. You will receive interview details shortly
2. Please prepare for a technical discussion
3. Have examples of your work ready
4. Come prepared with questions about the role
...
{company_name} Recruiting Team
        ...
        # For now, just return success (you can add actual email sending later)
...
def schedule_interview_simple(candidate_email: str, role: str, company_name: str = "Our Company") -> str:
    """Simple interview scheduling without agents"""
    try:
        # Generate a simple interview link
        interview_link = f"https://zoom.us/j/123456789?pwd=interview123"
        
        # Simple email content
        subject = f"Interview Scheduled - {role} Position"
        body = f"""
Dear Candidate,

Your interview for the {role} position at {company_name} has been scheduled.

Interview Details:
- Date: Tomorrow at 11:00 AM IST
- Duration: 60 minutes
...
{company_name} Recruiting Team
        ...
        print(f"Interview scheduled for {candidate_email}: {interview_link}")
